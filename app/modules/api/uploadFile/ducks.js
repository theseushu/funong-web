...
export const actions = {
  uploadFile: ({ key, filename, dataUrl, onprogress, meta }) => ({ type: UPLOAD_FILE, payload: { filename, dataUrl, onprogress }, meta: { key, ...meta } }),
...
export function* uploadFileSaga({ payload: { filename, dataUrl, onprogress }, meta: { key, resolve, reject } }, api) {
  ...
  try {
    ...
    const uploadedFile = yield call(api.uploadFile, {
      ...
      onprogress,
      metaData: { owner: currentUser.objectId },
    });
