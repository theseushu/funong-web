...
import { createShopProductSelector, myShopSelector } from 'modules/data/ducks/selectors';
...
export default connect(
  (state, { params: { id } }) => ({ product: id === 'new' ? null : createShopProductSelector(id)(state), shop: myShopSelector(state) })
)(ProductPage);
