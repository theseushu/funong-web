...
class ProductDetails extends Component {
  ...
  state = { specIndex: 0 }
  render() {
    const { product: { name, images, category, species, specs, updatedAt }, location, classes } = this.props;
        ...
        <Cell col={8} tablet={8} phone={4}>
          <Card shadow={2} className={classes.card}>
            ...
            <CardActions border className={classes.buttons}>
              ...
              <AddToCartButton type="shop" product={this.props.product} specIndex={specIndex} quantity={specs[specIndex].minimum}>加入购物车</AddToCartButton>
            </CardActions>
          </Card>
        </Cell>
      </Grid>
