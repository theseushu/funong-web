...
class DatesDialog extends Component {
  static propTypes = {
      ...
      <Dialog
        ...
        fixedContent={
          <div>
            ...
            <div style={{ paddingLeft: '2em' }}><small>{displayPeriod(start, end) || '请选择起止日期'}</small></div>
          </div>
        }
        scrollableContent={
          <div>
...
export default injectSheet(styles)(DatesDialog);
