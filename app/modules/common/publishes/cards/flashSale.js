...
import { briefAddress, formatPrices, formatParams, humanizeTime, formatStartAndEndTime } from 'funong-common/lib/utils/displayUtils';
...
const ProductCard = ({ publish, actions, classes }) => {
      ...
      <div className={classes.content}>
        <div className={classes.specsOwnerAndBadge}>
          ...
          <div className={classes.locationAndUpdateTime}>
            <p>{briefAddress(publish.shop.location.address)}</p><p>{humanizeTime(publish.updatedAt)}</p>
          </div>
        </div>
      </div>
      <CardActions border>
