...
import { reduxForm, SubmissionError, Field, formValueSelector } from 'redux-form';  // eslint-disable-line no-unused-vars
...
import { createProduct, selector } from '../../api/createProduct';
    ...
    <form
      onSubmit={handleSubmit(({ species, specifications, price, available, dates, location, desc, photos }) => {
        ...
        return new Promise((resolve, reject) => {
          props.createProduct({ species, specifications, price, available, startAt: start, endAt: end, desc, photos, geopoint, location: address, meta: {
            resolve,
            reject,
          } });
        });
...
export default reduxForm({
  ...
  (dispatch) => bindActionCreators({ createProduct }, dispatch),
)(Form)));
