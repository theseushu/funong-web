  ...
  const actionSaga = function* ({ payload, meta: { resolve, reject } }, api) {
    ...
    try {
      ...
      if (beforeFulfilledSaga) {
        yield* beforeFulfilledSaga(result, { payload, meta: { resolve, reject } });
      }
 ...
 * @param beforeFulfilled optioal generator function to call before finishing api call. typical usage would be set data by normalizr
