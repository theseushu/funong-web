...
export const startAt = {
  create: (product, value) => setRequiredAttr(product, 'startAt', value),
  update: (product, value) => setRequiredAttr(product, 'startAt', value),
  search: undefined,
  converter: attrConverters.startAt,
};

export const endAt = {
  create: (product, value) => setRequiredAttr(product, 'endAt', value),
  update: (product, value) => setRequiredAttr(product, 'endAt', value),
  search: undefined,
  converter: attrConverters.startAt,
};
